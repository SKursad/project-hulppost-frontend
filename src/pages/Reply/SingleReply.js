            ...
            <main className="main-reply">
                ...
                {Object.keys(replyData).length > 0 ? (
                    <article id="article-reply">
                        ...
                        <p>Bericht:</p>
                        <Link to={`/request/${replyData.requestId}`}>
                            <p className="article-reply__p">{replyData.text}</p>
                        </Link>
                        <br />
                ...
                {context.user.id === replyData.userId ? (<>
                    <div className="main-reply__div-button">
                        <Button id="main-reply__button" type="button" onClick={() => navigate(`/edit-reply/${id}`)}>UPDATEN<MdUpdate /></Button>
