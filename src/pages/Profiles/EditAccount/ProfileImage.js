            ...
            <form className="edit-image" onChange={(e) => onClickSave(e)}>
                ...
                <div className="edit-image__div">
                    ...
                    {context.user.roles === "ROLE_HELP-SEEKER" ? (
                        <Button id="edit-image__button" type="button" onClick={() => navigate(`/profile/${id}`)}>
                            ANNULEREN&nbsp;
                            <MdCancel />
                        </Button>
                    ) : (
                        <Button id="edit-image__button" type="button" onClick={() => navigate(`/profile-volunteer/${id}`)}>
                            ANNULEREN&nbsp;
                            <MdCancel />
                        </Button>
                    )}
                    <Button id="edit-image__button-del" onClick={deleteHandler}>
                        FOTO VERWIJDEREN&nbsp;
